...
A list of awesome Machine Translation frameworks, libraries, software and papers. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,241 | 🐛 29 | 🌐 Python | 📅 2026-08-27.
...
* [LibreTranslate](https://github.com/LibreTranslate/LibreTranslate) ⭐ 16,274 | 🐛 124 | 🌐 Python | 📅 2026-09-02 - A free and open source machine translation API.
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,421 | 🐛 160 | 🌐 Python | 📅 2026-08-08 - An open-source offline translation library written in Python. Uses OpenNMT for translations, SentencePiece for tokenization, Stanza for sentence boundary detection, and PyQt for GUI.
* [translateLocally](https://github.com/XapaJIaMnu/translateLocally) ⭐ 626 | 🐛 53 | 🌐 C++ | 📅 2025-03-30 - A fast and secure translation on your local machine, powered by marian and Bergamot.
...
* [ModernMT](https://github.com/ModernMT/MMT) ⭐ 352 | 🐛 68 | 🌐 Java | 📅 2022-07-07 - A neural adaptive machine translation that adapts to context and learns from corrections.
