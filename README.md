...
A list of awesome Machine Translation frameworks, libraries, software and papers. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,358 | 🐛 29 | 🌐 Python | 📅 2026-09-17.
...
* [LibreTranslate](https://github.com/LibreTranslate/LibreTranslate) ⭐ 16,687 | 🐛 126 | 🌐 Python | 📅 2026-09-03 - A free and open source machine translation API.
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,477 | 🐛 161 | 🌐 Python | 📅 2026-08-08 - An open-source offline translation library written in Python. Uses OpenNMT for translations, SentencePiece for tokenization, Stanza for sentence boundary detection, and PyQt for GUI.
* [translateLocally](https://github.com/XapaJIaMnu/translateLocally) ⭐ 629 | 🐛 53 | 🌐 C++ | 📅 2025-03-30 - A fast and secure translation on your local machine, powered by marian and Bergamot.
...
* [OpusFilter](https://github.com/Helsinki-NLP/OpusFilter) ⭐ 115 | 🐛 5 | 🌐 Python | 📅 2026-09-16 - A tool for filtering and combining parallel corpora.
* [Corpora Cleaning Tools](https://github.com/M4t1ss/parallel-corpora-tools) ⭐ 42 | 🐛 1 | 🌐 PHP | 📅 2023-12-19 - Tools for filtering and cleaning parallel and monolingual corpora in order to train better (neural) machine translation systems.
